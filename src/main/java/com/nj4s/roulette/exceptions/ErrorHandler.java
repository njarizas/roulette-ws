...
public class ErrorHandler {
   ...
   public ResponseEntity<ExceptionInfo> badRequestException(HttpServletRequest request, com.fasterxml.jackson.databind.exc.InvalidFormatException e) {
       ExceptionInfo exceptionInfo = new ExceptionInfo(HttpStatus.BAD_REQUEST.value(), e.getClass().getSimpleName(), Constants.BET_OPTION_NOT_VALID, request.getRequestURI());
       return new ResponseEntity<>(exceptionInfo, HttpStatus.BAD_REQUEST);
   }
